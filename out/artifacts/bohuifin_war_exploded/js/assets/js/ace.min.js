...
ace.handle_side_menu = function(a) {
    ...
    function() {
        ...
        jQuery.post("question/setCollapsed",{'collState':!c},function (data) {
        	if (!c) {
        		a("#sidebar").addClass("menu-min");
        	}
        });
    });
    ...
    function(h) {
        ...
        if ($(g).find("b").hasClass("arrow icon-angle-down")) {
        	$(g).find("b").removeClass("arrow icon-angle-down");
        	$(g).find("b").addClass("arrow icon-angle-up");
        } else if ($(g).find("b").hasClass("arrow icon-angle-up")) {
        	$(g).find("b").removeClass("arrow icon-angle-up");
        	$(g).find("b").addClass("arrow icon-angle-down");
        }
