                        ...
                        <div class="col-xs-12">
                            <h3 class="header smaller lighter blue">
                                <c:if test="${!requestScope.act eq 'add'}">
                                    <h3 class="header smaller lighter blue">增加管理员</h3>
                                </c:if>
                                <c:if test="${!requestScope.act eq 'edit'}">
                                    <h3 class="header smaller lighter blue">修改管理员</h3>
                                </c:if>
                            </h3>
                            <form action="<%=SystemConst.BASE_PATH%>admin/managers/saveManager"
                                  method="post" class="form-horizontal" id="managerForm">
                                <div class="table-responsive" id="responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr>
                                            <td style="width:10%;">管理员名称</td>
                                            <td><input type="text" class="col-xs-10 col-sm-5"
                                                       name="managerName" id="managerName"
                                                       value="${requestScope.manager.managerName }"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="col-xs-10 col-sm-5"
                                                       ...
                                                       value="${requestScope.manager.trueName }"
                                                       style="display: inline;"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="col-xs-10 col-sm-5"
                                                       ...
                                                       value="${requestScope.manager.nickName }"
                                                       style="display: inline;"></td>
                                        </tr>
                                        <tr>
                                            <td>排序</td>
                                            <td><c:choose>
                                                <c:when test="${requestScope.manager.listOrder eq 0 }">
                                                    <input type="text" class="col-xs-1" name="listOrder"
                                                           style="display: inline;">
                                                </c:when>
                                                <c:otherwise>
                                                    <input type="text" class="col-xs-1" name="listOrder"
                                                           value="${requestScope.manager.listOrder }"
                                                           style="display: inline;">
                                                </c:otherwise>
                                            </c:choose></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="center">
                                                ...
                                                <input type="hidden" name="managerId" value="${requestScope.manager.managerId}"/>
