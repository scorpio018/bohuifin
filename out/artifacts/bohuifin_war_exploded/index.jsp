        ...
        <div class="content">
            ...
            <div class="buy-item" style="margin-top:16.0px;">
                <div class="item-left" style="position:relative;">
                    ...
                    <a href="#" title="">
                        <img class="photo" src="<%=SystemConst.BASE_PATH%>images/index/img-user.jpg" alt="">
                    </a>
                    <div class="user-name"><a href="#">黑马哥</a></div>
                </div>
                <div class="item-center">
                    <div style="margin-top:20px; padding-left:20px;">
                        <div style="float:left;">
                            <span class="radius loan_type_icon showTip L30 layer_tip_1 poshytip" title="保本型：本金保障+浮动收益">保本型</span>
                            <span class="radius product_icon">股票</span>
                        </div>
                        <a href="#" title="">
                            <div class="item-name">黑马哥保本二</div>
                        </a>
                        <div class="clear"></div>
                    </div>
                    <div>
                        ...
                        <ul class="item-data-row">
                            <li style="width:108px;"><span class="big">56</span>&nbsp;万元</li>
                            <li style="width:85px;">T+<span class="big">50</span></li>
                            <li style="width:85px;"><span class="big">70</span>&nbsp;%</li>
                            <li style="width:102px;"><span class="big">0</span>&nbsp;%</li>
                        </ul>
                    </div>
                </div>
                <div class="item-right">
                    ...
                    <button class="view-button bg_orange" onclick="#">正在投资</button>
                </div>
            </div>
            <!-- 合买项目 结束 -->
            ...
            <div class="buy-item" style="margin-top:16.0px;">
                <div class="item-left" style="position:relative;">
                    <div class="star level_stars">
                        <i class="demo-icon icon-star"></i><i class="demo-icon icon-star"></i><i
                            class="demo-icon icon-star"></i><i class="demo-icon icon-star"></i><i
                ...
                <div class="item-center">
                    <div style="margin-top:20px; padding-left:20px;">
                        <div style="float:left;">
                            <span class="radius loan_type_icon_red showTip L31 layer_tip_2 poshytip"
                                  title="进取型：本金止损+超高分成">进取型</span>
                            <span class="radius product_icon">股票</span>
                        </div>
                        <a href="#" title="">
                            <div class="item-name">黑马哥保本二</div>
                ...
                <div class="item-right">
                    ...
                    <button class="view-button bg_white" onclick="#">投资结束</button>
                </div>
            </div>
            <!-- 合买项目 结束 -->
            ...
            <div class="buy-item" style="margin-top:16.0px;">
                ...
                <div class="item-center">
                    <div style="margin-top:20px; padding-left:20px;">
                        <div style="float:left;">
                            <span class="radius loan_type_icon_org showTip L32 layer_tip_3 poshytip"
                                  title="稳盈型：保底收益+浮动收益">稳盈型</span>
                            <span class="radius product_icon">股票</span>
                        </div>
                        <a href="#" title="">
                            <div class="item-name">黑马哥保本二</div>
