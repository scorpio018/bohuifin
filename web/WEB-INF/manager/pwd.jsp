...
<body>
<c:choose>
    <c:when test="${sessionScope.managerLogin==null}">
    ...
    <c:otherwise>
        ...
        <div style="display:inline;">${sessionScope.managerLogin.managerName}</div>
        <br>
        <div class="space-4">
            <div class="space-4"></div>
        </div>
        <label style="width:90px;">真实姓名：</label>
        <div style="display:inline;">${sessionScope.managerLogin.trueName}</div>
        <br>
        <div class="space-4">
            <div class="space-4"></div>
        </div>
